...
<head>
    ...
    <!--  favicon -->
    <link rel="shortcut icon" href="/resources/assets/img/ico/favicon.png">
    <!--  apple-touch-icon -->
    ...
    <!-- Material Icons CSS -->
    <link href="/resources/assets/fonts/iconfont/material-icons.css" rel="stylesheet">
    <!-- materialize -->
    <link href="/resources/assets/materialize/css/materialize.min.css" rel="stylesheet">
    <!-- Bootstrap -->
    ...
    <div class="valign-cell">
        <div class="container">
            ...
            <div class="comingsoon-wrapper text-center">
                <div class="logo">
                    <a href="#">
                        <img src="/resources/assets/img/icon-logo.png" alt="">
                    </a>
                </div><!-- /.logo -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-logo">
                        <a target="_blank" href="https://themeforest.net/item/matrox-material-design-multipurpose-html-template/16917670?ref=TrendyTheme"><img src="/resources/assets/img/logo-white.png" alt=""></a>
                    </div>
...
<script src="/resources/assets/js/coundown-timer.js"></script>
...
<script src="/resources/assets/js/ajaxchimp.js"></script>
<script src="/resources/assets/js/ajaxchimp-config.js"></script>
